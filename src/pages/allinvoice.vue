  ...
  <base-layout PageTitle="All invoices">
    ...
    <div class="total_earning animate__animated animate__fadeInUp">
        <ion-row class="ion-text-center">
            <ion-col size="12">
                <ion-hearder>
        <ion-searchbar @ionBlur="hideColor" @ionFocus="showSearchColorMethod" :class="{'ion-backprimary':showSearchColor }"></ion-searchbar>
      </ion-hearder>
            </ion-col>
        </ion-row>
    </div>
    ...
    <ion-list lines="none" v-show="false" >
        <h2>Customers</h2>
        <ion-item button='true' @click="$router.push('/customerdetail')" class="animate__animated animate__fadeInUp" router-link="/customerdetail">
            <ion-row>
                <ion-col size="7">
        ...
        <ion-item button="true" @click="$router.push('/customerdetail')" class="animate__animated animate__fadeInUp" >
            <ion-row>
                <ion-col size="7">
